...
export default function Footer() {
	return (
		// Force the footer to always use its dark styling, in both light and
		// dark site themes — the `dark` variant is `&:is(.dark *)`, so a local
		// `.dark` wrapper turns on every `dark:` utility inside the footer.
		<div className="dark">
